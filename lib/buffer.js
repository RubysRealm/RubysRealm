...
export async function findBufferVideoPostBySource({ channelId, videoUrl, caption = '', allowDisabled = false, first = 60, dedupeCaption = false }) {
...
export async function createBufferVideoPost({ channelId, caption, videoUrl, dueAt = null, allowDisabled = false, dedupeVideoUrl = true, dedupeCaption = false }) {
  ...
  if (dedupeVideoUrl) {
    const duplicate = await findBufferVideoPostBySource({ channelId, videoUrl, caption, allowDisabled, dedupeCaption });
