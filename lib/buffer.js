...
export async function findBufferVideoPostBySource({ channelId, videoUrl, caption = '', allowDisabled = false, first = 60, dedupeCaption = true }) {
...
export async function createBufferVideoPost({ channelId, caption, videoUrl, dueAt = null, allowDisabled = false, dedupeVideoUrl = true, dedupeCaption = true }) {
