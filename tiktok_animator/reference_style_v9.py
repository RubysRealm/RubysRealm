    ...
    def reference_image(beat,seed,dest):
        ...
        try:
            ...
            prompt=(
                ...
                'Show the character actively doing the narrated action inside a specific detailed illustrated environment; '
                'include the important location and story objects, varied camera angle, strong readable silhouette. '
